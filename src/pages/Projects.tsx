...
const projects = [
  {
    ...
    description:
      'Внедрение процесса массового подбора с применением роботов, аутсорсинг рутинных операций, в результате нанято 193 высококвалифицированных машинистов ДСТ и водителей самосвалов категории С и Д.',
